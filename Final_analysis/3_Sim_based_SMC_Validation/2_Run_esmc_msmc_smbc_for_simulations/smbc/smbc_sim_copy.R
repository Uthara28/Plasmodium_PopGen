...
mut_rate <- 1e-06
in_path <- "/data/proj2/home/students/u.srinivasan/Plasmodium_us/Inputs/msprime_sims/Sims_for_eSMC_SMBC/input_vcfs_ts_mhsf/forsmbc_kingman_3haps_10Mb/const/kingman/m1e-06/Kingman_rep0_m1e-06_ratio0.1_rs152423716.vcf"
out_dir <- "/data/proj2/home/students/u.srinivasan/Plasmodium_us/Inputs/msprime_sims/Sims_for_eSMC_SMBC/SMBC_outs/const_popsize/kingman_3haps_10mb_const"
file_name <- basename(in_path)  # Get the VCF file name
...
Os <- eSMC2::Process_vcf_data(in_path)
